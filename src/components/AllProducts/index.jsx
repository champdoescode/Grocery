...
const AllProducts = () => {
  ...
  const uniqueBrands = [...new Set(productsData.subCategories.flatMap(subCat => subCat.products.map(product => product.brand)))];
    ...
    <div className="p-4 mt-40">
      <div className="flex space-x-4">
        <div className="w-1/4">
          ...
          {productsData.subCategories.map(subCat => (
            <button
          ...
          <div className="grid grid-cols-3 gap-4">
            {productsData.subCategories
              ...
              .map((product) => {
                ...
                return (
                  <div key={product.prod_name} className="border p-4 relative">
